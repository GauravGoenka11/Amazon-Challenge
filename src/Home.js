    ...
    return (
        <div className="home">
            ...
            <div className="home_row">
                {/* The below 2 lines will give the product with same image */}
                {/* <Product/> */}
                {/* <Product/> */}
                
                {/* So here we are passing the props value i.e title,price,rating and image from product props */}
                <Product
            id="12321341"
          ...
          />
            ...
            <div className="home_row">
                {/* The below 3 lines will give the product with same image */}
                {/* <Product/> */}
                {/* <Product/> */}
                {/* <Product/> */}
